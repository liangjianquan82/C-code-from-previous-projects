<%@ Page language="c#" Codebehind="JFnotintList.aspx.cs" AutoEventWireup="false" Inherits="NrOA.CheckAccount.JFnotintList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>JFnotintList</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="0" cellPadding="0" width="99%" align="center" border="0">
				...
				<tr>
					...
					<td vAlign="middle" align="center" colSpan="2" height="30"><FONT face="宋体" color="#3399cc" size="3"><B><asp:label id="Label6" runat="server" Font-Size="Medium" ForeColor="#3399CC">未对应缴费信息列表</asp:label></B></FONT></td>
						...
						<table cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD style="HEIGHT: 24px">
									...
									<asp:RadioButton id="rb_ycx" runat="server" Text="一次性" TextAlign="Left" Checked="True" AutoPostBack="True"></asp:RadioButton>
									<asp:RadioButton id="rb_sy" runat="server" Text="使用" TextAlign="Left" AutoPostBack="True"></asp:RadioButton></TD>
								...
								<td width="100%"><asp:datagrid id="DataGrid1" runat="server" AllowPaging="True" CellPadding="3" BackColor="White"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="客户业务号">
												...
												<ItemTemplate>
													<%#DataBinder.Eval(Container,"DataItem.usernb")%>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:BoundColumn DataField="t_onepay" HeaderText="一次性">
												<HeaderStyle Width="90px"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="t_year" HeaderText="年">
												<HeaderStyle Width="90px"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="t_month" HeaderText="月">
												<HeaderStyle Width="90px"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="month_fc" HeaderText="分成">
												<HeaderStyle Width="90px"></HeaderStyle>
											</asp:BoundColumn>
										</Columns>
									...
									<asp:datagrid id="Datagrid2" runat="server" Width="100%" AutoGenerateColumns="False" HorizontalAlign="Left"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="month_pay" HeaderText="使用费">
												<HeaderStyle Width="90px"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="t_year" HeaderText="年">
												<HeaderStyle Width="90px"></HeaderStyle>

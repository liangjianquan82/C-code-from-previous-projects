<%@ Page language="c#" Codebehind="ChargeOneVeiw.aspx.cs" AutoEventWireup="false" Inherits="NrOA.CheckAccount.ChargeOneVeiw" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ChargeOneVeiw</title>
			...
			<FORM id="addtask" method="post" runat="server">
				<TBODY>
					...
					<tr>
						...
						<td vAlign="middle" align="center" colSpan="2" height="30"><asp:label id="Label_Title" runat="server" Font-Bold="True" ForeColor="#3399CC" Font-Size="Medium">新增/修改一次性信息</asp:label></td>
					...
					<tr>
						...
						<td vAlign="top" colSpan="2"><FONT face="宋体">
								<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="1">
									...
									<TR>
										<TD>迁移费用：</TD>
										<TD><asp:textbox id="TextBox4" runat="server" Width="98%">0</asp:textbox></TD>
										<TD align="center">&nbsp;</TD>
									</TR>
									<TR>
										<TD>分成比例：</TD>

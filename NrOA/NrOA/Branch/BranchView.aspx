<%@ Page language="c#" Codebehind="BranchView.aspx.cs" AutoEventWireup="false" Inherits="NrOA.Branch.BranchView" %>
			...
			<FORM id="addtask" method="post" runat="server">
				<TBODY>
					...
					<tr>
						...
						<td vAlign="middle" align="center" colSpan="2" height="30"><asp:label id="Label_Title" runat="server" Font-Bold="True" ForeColor="#3399CC" Font-Size="Medium">新增/修改部门</asp:label></td>
